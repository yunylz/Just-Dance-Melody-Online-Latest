...
registerProcessor("JD_CarouselFriendChallengesRequestDesc", async (requestDesc: any, req: Request) => {
    ...
    return challengers.getFriendChallenges({
        profileId: pid,
        ...
        onlineChallengeCount: requestDesc.onlineChallengeCount,
        offlineChallengeCount: requestDesc.offlineChallengeCount,
        onlineScoreCount: requestDesc.onlineScoreCount,
        offlineScoreCount: requestDesc.offlineScoreCount,
